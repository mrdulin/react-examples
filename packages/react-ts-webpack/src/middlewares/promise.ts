...
const createPromiseWithStateMiddleware = function (...args: any[]): Middleware {
  
  return ({dispatch, getState}: MiddlewareAPI<IState>) => (next: Dispatch<IState>): any => (action: ActionMeta<any, any>): any => {
