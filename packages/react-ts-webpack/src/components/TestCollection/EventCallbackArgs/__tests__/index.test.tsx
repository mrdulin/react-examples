...
describe('component - EventCallbackArgs test suites', () => {
  ...
  describe('test utils', () => {
    ...
    it('should be get the correct value by trigger the click event', (done: jest.DoneCallback) => {
      ...
      const comp: any = TestUtils.renderIntoDocument(<Component onClick={clickCallback}/>);
  ...
  describe('shallow rendering', () => {
    ...
    it('renders correctly', () => {
      ...
      expect(inputInstance).toEqual( <input type="text" onChange={inputInstance.props.onChange} value="" />);
