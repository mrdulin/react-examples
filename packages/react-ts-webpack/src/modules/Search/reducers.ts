...
export const pagingReducer: Reducer<IPaging> = handleActions<IPaging, ISearchEntity<Book>>({
...
export const itemsReducer: Reducer<Book[]> = handleActions<Book[], SearchPayload>({
...
const queryReducer: Reducer<string> = handleAction<string, ISearchEntity<ISearchBook>, ISearchParams>(
...
const itemReducer: Reducer<Book> = handleActions<Book, ISearchBook>({
...
const moduleReducer: Reducer<ISearchReducerState<Book>> = combineReducers<ISearchReducerState<Book>>({
